      ...
      <div className="projectContainer row">
        <div className="projectCard col">
            ...
            <div className="projectDesc">
              ...
              <p>Website and CMS developed for the Alliance for Entreprenuerial Universities in Africa</p>
        ...
        <div className="projectCard col">
            ...
            <div className="projectDesc">
              <span>FAMALINK</span>
              <p>An agritech solution aimed at helping farmers to make data driven farm budgeting and other farm decisions</p>
              <a href=""></a>
            </div>
        </div>
        <div className="projectCard col">
            ...
            {/* </div> */}
            <div className="projectDesc">
              <span>K-Unity Transport Requisition Portal</span>
              <p>A web solution designed for K-UNITY sacco for manage transport requisitions in the institution and manage fleet</p>
              <a href=""></a>
            </div>
        </div>
      </div>
